...
namespace DiffLib
{
    ...
    public sealed class LongestCommonSubstring<T>
    {
        ...
        {
            if (lower1 < 0)
                throw new ArgumentOutOfRangeException("lower1");
            if (lower1 > upper1)
                throw new ArgumentOutOfRangeException("lower1");
            if (upper1 > _Collection1.Length)
                throw new ArgumentOutOfRangeException("upper1");
            if (lower2 < 0)
                throw new ArgumentOutOfRangeException("lower2");
            if (lower2 > upper2)
                throw new ArgumentOutOfRangeException("lower2");
            if (upper2 > _Collection2.Length)
                throw new ArgumentOutOfRangeException("upper2");
